  ...
  return (
    <div className='mt-35 w-[90vw] lg:max-w-[80vw] xl:max-w-[70vw] mx-auto md:flex md:justify-between gap-5'>
        ...
        <div className='flex flex-col gap-5 min-w-50 pb-7'>
            <button className='flex justify-between px-8 py-3 backdrop-blur-xl shadow-[0px_1px_10px_rgb(var(--accent-shadow),0.2)] rounded-md whitespace-nowrap text-accent cursor-pointer'>
